...
export interface InspectionPlanRepository {
  ...
  list(tenantId: TenantId, filter?: { status?: PlanStatus; materialCode?: string }): Promise<InspectionPlan[]>;
}
...
export interface CapaRepository {
  ...
  list(tenantId: TenantId, filter?: { status?: CapaStatus; ncrId?: Ulid }): Promise<CapaCase[]>;
}
