...
import { buildProcurementRouter } from "./app.js";
import { errorToResponse, type Router } from "./router.js";
...
/** Node HTTP server wrapping the procurement router. Caller owns listen/close. */
export function createProcurementServer(module: ProcurementModule): Server {
  const router = buildProcurementRouter(module);
