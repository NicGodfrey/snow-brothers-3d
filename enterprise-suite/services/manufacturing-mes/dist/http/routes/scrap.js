...
import { asRecord, optionalNumber, optionalOneOf, optionalString, requireNumber, requireOneOf, requireString, } from "../validate.js";
export function registerScrapRoutes(router, container) {
