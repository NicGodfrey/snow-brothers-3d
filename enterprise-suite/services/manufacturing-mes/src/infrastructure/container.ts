...
import {
  InMemoryCapacityCalendarRepository,
  InMemoryMaterialIssueRepository,
  InMemoryProductionReceiptRepository,
  InMemoryRoutingRepository,
  InMemoryScrapRecordRepository,
  InMemoryShiftTemplateRepository,
  InMemoryWorkCenterRepository,
...
export function createContainer(options?: { clock?: Clock }): MesContainer {
