import type { MaterialIssueLineInput } from "../../domain/material-issue.js";
...
function parseLines(body: Record<string, unknown>): MaterialIssueLineInput[] {
...
export function registerMaterialRoutes(router: Router, container: MesContainer): void {
