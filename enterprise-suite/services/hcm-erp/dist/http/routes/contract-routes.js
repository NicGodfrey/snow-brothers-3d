import { actorId, asRecord, dateField, enumField, moneyField, optDateField, optEnumField, optMoneyField, optNum, optStr, requireRole, ulidField, ulidParam, } from "../parse.js";
...
export function registerContractRoutes(router, module) {
    ...
    router.get("/contracts/:id", (req) => jsonOk(contractService.getContract(req.ctx.tenantId, ulidParam(req.params, "id")).toJSON()));
    router.get("/employees/:id/contracts", (req) => jsonOk({
    ...
    router.post("/contracts/:id/amend", (req) => {
        ...
        if (weeklyHours !== undefined)
            changes.weeklyHours = weeklyHours;
